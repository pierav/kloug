...
class kloug(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","kloug_fesvr")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for kloug start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
    ...
    def runTests(self, testList):
	  ...
	  # echo statement.
          if self.target_run:
            ...
            simcmd = self.dut_exe + ' +signature={} +signature-granularity=4 {}'.format(sig_file, elf)
          else:
            simcmd = 'echo "NO RUN"'

          # concatenate all commands that need to be executed within a make-target.
          execute = 'echo "RUN..."; cd {0}; {1}; {2};'.format(testentry['work_dir'], cmd, simcmd)
